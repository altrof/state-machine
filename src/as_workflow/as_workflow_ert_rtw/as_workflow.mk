...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/as_workflow
...
DEFINES_STANDARD = -DMODEL=as_workflow -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/as_workflow_ert_rtw/as_workflow.cpp

MAIN_SRC = $(START_DIR)/as_workflow_ert_rtw/ert_main.cpp
...
%.o : $(START_DIR)/as_workflow_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/as_workflow_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
as_workflow.o : $(START_DIR)/as_workflow_ert_rtw/as_workflow.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/as_workflow_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
